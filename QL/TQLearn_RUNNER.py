            ...
            for eps_0 in esp0_list:
                for ALPHA in ALPHA_list:
                    for dt_size in Training_traj_size_list:
                        ...
                        test_size = num_rzns - dt_size   #number of trajetcories to be used for testing
                        ...
                        Q, policy, max_delQ_list_2 = Q_learning_Iters(Q, N, g, policy, Vx_rzns, Vy_rzns, train_id_list, N_inc, alpha=ALPHA, QIters=QL_Iters,
